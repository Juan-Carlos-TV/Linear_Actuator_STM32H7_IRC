...
/* Definitions for internalErrorQueue */
osMessageQueueId_t internalErrorQueueHandle;
const osMessageQueueAttr_t internalErrorQueue_attributes = {
  .name = "internalErrorQueue"
};
/* USER CODE BEGIN PV */
...
/* USER CODE END Boot_Mode_Sequence_1 */
  ...
  /* creation of internalErrorQueue */
  internalErrorQueueHandle = osMessageQueueNew (16, sizeof(uint16_t), &internalErrorQueue_attributes);
  ...
  canSendTaskHandle = osThreadNew(StartTask1, NULL, &canSendTask_attributes);

  /* creation of canReceiveTask */
  canReceiveTaskHandle = osThreadNew(StartTask02, NULL, &canReceiveTask_attributes);
