...
/* Definitions for core7_MotorCont */
osThreadId_t core7_MotorContHandle;
const osThreadAttr_t core7_MotorCont_attributes = {
  .name = "core7_MotorCont",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for core7_SensorPos */
osThreadId_t core7_SensorPosHandle;
const osThreadAttr_t core7_SensorPos_attributes = {
  .name = "core7_SensorPos",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityBelowNormal,
};
/* Definitions for core7_diagnosis */
osThreadId_t core7_diagnosisHandle;
const osThreadAttr_t core7_diagnosis_attributes = {
  .name = "core7_diagnosis",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityBelowNormal,
};
...
/* Definitions for diagnosQueue */
osMessageQueueId_t diagnosQueueHandle;
const osMessageQueueAttr_t diagnosQueue_attributes = {
  .name = "diagnosQueue"
};
/* USER CODE BEGIN PV */
