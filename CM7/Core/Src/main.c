...
const osThreadAttr_t core7_MotorCont_attributes = { .name = "core7_MotorCont",
...
const osThreadAttr_t core7_SensorPos_attributes =
		{ .name = "core7_SensorPos", .stack_size = 128 * 4, .priority =
...
const osThreadAttr_t core7_diagnosis_attributes =
		{ .name = "core7_diagnosis", .stack_size = 128 * 4, .priority =
				(osPriority_t) osPriorityBelowNormal, };
...
const osMessageQueueAttr_t doneQueue_attributes = { .name = "doneQueue" };
/* Definitions for diagnosQueue */
osMessageQueueId_t diagnosQueueHandle;
const osMessageQueueAttr_t diagnosQueue_attributes = { .name = "diagnosQueue" };
/* USER CODE BEGIN PV */
